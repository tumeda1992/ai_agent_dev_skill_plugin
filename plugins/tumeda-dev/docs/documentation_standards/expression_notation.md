...
ある内容を、**図・表・箇条書き・散文のどれで書き表すか**の標準。`documentation_standards/` の傘の下の 1 トピック。構造化の思想（何をどこに置くか）は [`information_structuring.md`](./information_structuring.md) が扱い、こちらは**書き表し方**を扱う。
